---
title: "BIMM143 Bfactor Analysis"
author: "Sahar Kamali"
date: "2026-01-28"
output: pdf_document
---
...
# Plot B-factors
plotb3(s1.b, sse = s1.chainA, typ = "l", ylab = "B-factor", main = "4AKE")
plotb3(s2.b, sse = s2.chainA, typ = "l", ylab = "B-factor", main = "1AKE")
plotb3(s3.b, sse = s3.chainA, typ = "l", ylab = "B-factor", main = "1E4Y")
...
The code can be generalized by writing a function that takes a PDB ID as input, trims the structure, extracts B-factors, and plots them automatically.


```{r analyze-pdb-function}
analyze_pdb <- function(pdb_id, chain = "A", elety = "CA") {
  # Inputs:
  # pdb_id: PDB ID string (e.g., "4AKE")
  # chain: which chain to keep (default "A")
  # elety: which atom type to keep (default "CA")
